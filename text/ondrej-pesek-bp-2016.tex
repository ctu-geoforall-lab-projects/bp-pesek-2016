...
frameworku Qt. Při vyvíjení zásuvného modulu bude přihlíženo
k~požadavkům a~připomínkám Státního ústavu radiační ochrany, který tento projekt inicioval.
Z~důvodu zachování úzu prostředí QGIS bude zásuvný modul vytvářen v jazyku Python.}%
...
(initiators of the~project) will be taken into consideration. Due to recent habit of QGIS software
