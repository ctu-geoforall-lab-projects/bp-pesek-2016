...
trajektorii (tzv.~leveling leteckých dat). Takový nástroj je třeba z~toho důvodu, že přístroj při
...
(aerial data leveling). The reason for this tool is that the instrument for aerial data surveying is
recording data with some delay. In practical part of bachelor thesis is implementation of this tool as
plugin into open source project QGIS using graphical framework Qt. 
 }

%% Klíčová slova
\klicovaslova
{GIS, QGIS, zásuvný~modul, python, leveling}%
{GIS, QGIS, plugin, python, leveling}
