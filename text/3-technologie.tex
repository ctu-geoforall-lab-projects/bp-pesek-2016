...
QGIS (zkratka dříve užívaného názvu Quantum~GIS) představuje na poli geogra\-fic\-kých informačních systémů (\zk{GIS}) open-source alternativu ke komerčním geografic\-kým informačním systémům typu~ArcGIS. 
